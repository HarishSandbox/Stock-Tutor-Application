 ...
 */
public class TotalValue implements ITutorCommand {

  private final ITextBasedView view;
  private final Features feature;

  /**
   * Creates a TotalValue object by taking in the view component.
   *
   ...
   *                done.
   */
  public TotalValue(ITextBasedView view, Features feature) {
    this.view = view;
  ...
  public void performCommand() {
    ...
    try {
      feature.getTotalValueForGivenDate(portfolioName, date);
      view.displayMenu();
